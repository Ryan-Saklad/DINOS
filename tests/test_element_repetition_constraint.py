...
def test_character_repetition_within_words_case_sensitive():
    ...
    assert constraint.validate("The quick brown fox jumps over the lazy dog") == True
    assert constraint.validate("The quick brown fox jumps over the lAazy dog") == True
    assert constraint.validate("The quick brown fox jumps over the laazy dog") == False
...
def test_word_repetition_within_sentences_case_sensitive():
    ...
    assert constraint.validate("The quick brown fox jumps over the lazy dog. The fox is quick and the dog is lazy.") == True
    assert constraint.validate("The quick brown fox jumps over the lazy dog. the fox is quick and the dog is lazy and the snake exists. The fox and the dog are friends.") == False
...
def test_word_repetition_within_paragraphs_case_sensitive():
    ...
    assert constraint.validate("The quick brown fox jumps over the lazy dog. The fox is quick and the dog is lazy.\n\nThe fox and the dog are friends. The fox likes to play with the dog.") == True
