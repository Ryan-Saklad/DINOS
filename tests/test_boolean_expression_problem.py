...
from benchmark.problems.boolean_expression_problem import BooleanExpressionResponseProblem
...
def test_boolean_expression_problem(expression, expected_result):
    problem = BooleanExpressionResponseProblem()
...
def test_boolean_expression_problem(expression, expected_result):
    problem = BooleanExpressionResponseProblem()
    problem.problem = expression
    problem.answer = BooleanExpressionResponseProblem()._evaluate(expression)
